...
Select Location, date, total_cases, total_deaths, (total_deaths/total_cases)*100 as DeathPercentage
From PortofolioProject..CovidDeath
Where total_cases >'1000' and (total_deaths/total_cases)*100 > '4'
order by 5 Desc
...
Select *, (RollingPeopleVaccinated/Population)*100 as VaccPercentagePopulation
From PopvsVac
...
--1. View For Percentage Population Vaccinated
...
Select * 
From GlobalCaseNumber

--3. View For Total Population Vs Vaccination
Use PortofolioProject 
GO
